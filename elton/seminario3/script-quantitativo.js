...
const url = '../final/final.html';

function checkedIntroducao(){
    if(document.getElementById("introducao1").checked){
        localStorage.setItem("Seminário03 Introdução Quantitativo", '0');
    }else if(document.getElementById("introducao2").checked){
        localStorage.setItem("Seminário03 Introdução Quantitativo", '1');
    }else if(document.getElementById("introducao3").checked){
        localStorage.setItem("Seminário03 Introdução Quantitativo", '2');
    }else if(document.getElementById("introducao4").checked){
        localStorage.setItem("Seminário03 Introdução Quantitativo", '3');
    }else if(document.getElementById("introducao5").checked){
        localStorage.setItem("Seminário03 Introdução Quantitativo", '4');
    }else if(document.getElementById("introducao6").checked){
        localStorage.setItem("Seminário03 Introdução Quantitativo", '5');
    }
} 
function checkedPostura(){
    if(document.getElementById("postura1").checked){
        localStorage.setItem("Seminário03 Postura Quantitativo", '0');
    }else if(document.getElementById("postura2").checked){
        localStorage.setItem("Seminário03 Postura Quantitativo", '1');
    }else if(document.getElementById("postura3").checked){
        localStorage.setItem("Seminário03 Postura Quantitativo", '2');
    }else if(document.getElementById("postura4").checked){
        localStorage.setItem("Seminário03 Postura Quantitativo", '3');
    }else if(document.getElementById("postura5").checked){
        localStorage.setItem("Seminário03 Postura Quantitativo", '4');
    }else if(document.getElementById("postura6").checked){
        localStorage.setItem("Seminário03 Postura Quantitativo", '5');
    }
} 
function checkedFluencia(){
    if(document.getElementById("fluencia1").checked){
        localStorage.setItem("Seminário03 Fluência Quantitativo", '0');
    }else if(document.getElementById("fluencia2").checked){
        localStorage.setItem("Seminário03 Fluência Quantitativo", '1');
    }else if(document.getElementById("fluencia3").checked){
        localStorage.setItem("Seminário03 Fluência Quantitativo", '2');
    }else if(document.getElementById("fluencia4").checked){
        localStorage.setItem("Seminário03 Fluência Quantitativo", '3');
    }else if(document.getElementById("fluencia5").checked){
        localStorage.setItem("Seminário03 Fluência Quantitativo", '4');
    }else if(document.getElementById("fluencia6").checked){
        localStorage.setItem("Seminário03 Fluência Quantitativo", '5');
    }
}
function checkedDiccao(){
    if(document.getElementById("diccao1").checked){
        localStorage.setItem("Seminário03 Dicção Quantitativo", '0');
    }else if(document.getElementById("diccao2").checked){
        localStorage.setItem("Seminário03 Dicção Quantitativo", '1');
    }else if(document.getElementById("diccao3").checked){
        localStorage.setItem("Seminário03 Dicção Quantitativo", '2');
    }else if(document.getElementById("diccao4").checked){
        localStorage.setItem("Seminário03 Dicção Quantitativo", '3');
    }else if(document.getElementById("diccao5").checked){
        localStorage.setItem("Seminário03 Dicção Quantitativo", '4');
    }else if(document.getElementById("diccao6").checked){
        localStorage.setItem("Seminário03 Dicção Quantitativo", '5');
    }
}
function checkedDominio(){
    if(document.getElementById("dominio1").checked){
        localStorage.setItem("Seminário03 Domínio Quantitativo", '0');
    }else if(document.getElementById("dominio2").checked){
        localStorage.setItem("Seminário03 Domínio Quantitativo", '1');
    }else if(document.getElementById("dominio3").checked){
        localStorage.setItem("Seminário03 Domínio Quantitativo", '2');
    }else if(document.getElementById("dominio4").checked){
        localStorage.setItem("Seminário03 Domínio Quantitativo", '3');
    }else if(document.getElementById("dominio5").checked){
        localStorage.setItem("Seminário03 Domínio Quantitativo", '4');
    }else if(document.getElementById("dominio6").checked){
        localStorage.setItem("Seminário03 Domínio Quantitativo", '5');
    }
}
function checkedPreparacao(){
    if(document.getElementById("preparacao1").checked){
        localStorage.setItem("Seminário03 Preparação Quantitativo", '0');
    }else if(document.getElementById("preparacao2").checked){
        localStorage.setItem("Seminário03 Preparação Quantitativo", '1');
    }else if(document.getElementById("preparacao3").checked){
        localStorage.setItem("Seminário03 Preparação Quantitativo", '2');
    }else if(document.getElementById("preparacao4").checked){
        localStorage.setItem("Seminário03 Preparação Quantitativo", '3');
    }else if(document.getElementById("preparacao5").checked){
        localStorage.setItem("Seminário03 Preparação Quantitativo", '4');
    }else if(document.getElementById("preparacao6").checked){
        localStorage.setItem("Seminário03 Preparação Quantitativo", '5');
    }
}
function checkedAparenciaApresentacao(){
    if(document.getElementById("aparencia-apresentacao1").checked){
        localStorage.setItem("Seminário03 Aparência Apresentação Quantitativo", '0');
    }else if(document.getElementById("aparencia-apresentacao2").checked){
        localStorage.setItem("Seminário03 Aparência Apresentação Quantitativo", '1');
    }else if(document.getElementById("aparencia-apresentacao3").checked){
        localStorage.setItem("Seminário03 Aparência Apresentação Quantitativo", '2');
    }else if(document.getElementById("aparencia-apresentacao4").checked){
        localStorage.setItem("Seminário03 Aparência Apresentação Quantitativo", '3');
    }else if(document.getElementById("aparencia-apresentacao5").checked){
        localStorage.setItem("Seminário03 Aparência Apresentação Quantitativo", '4');
    }else if(document.getElementById("aparencia-apresentacao6").checked){
        localStorage.setItem("Seminário03 Aparência Apresentação Quantitativo", '5');
    }
}
function checkedAparenciaMaterial(){
    if(document.getElementById("aparencia-material1").checked){
        localStorage.setItem("Seminário03 Aparência Material Quantitativo", '0');
    }else if(document.getElementById("aparencia-material2").checked){
        localStorage.setItem("Seminário03 Aparência Material Quantitativo", '1');
    }else if(document.getElementById("aparencia-material3").checked){
        localStorage.setItem("Seminário03 Aparência Material Quantitativo", '2');
    }else if(document.getElementById("aparencia-material4").checked){
        localStorage.setItem("Seminário03 Aparência Material Quantitativo", '3');
    }else if(document.getElementById("aparencia-material5").checked){
        localStorage.setItem("Seminário03 Aparência Material Quantitativo", '4');
    }else if(document.getElementById("aparencia-material6").checked){
        localStorage.setItem("Seminário03 Aparência Material Quantitativo", '5');
    }
}
function checkedPontualidade(){
    if(document.getElementById("pontualidade1").checked){
        localStorage.setItem("Seminário03 Pontualidade Quantitativo", '0');
    }else if(document.getElementById("pontualidade2").checked){
        localStorage.setItem("Seminário03 Pontualidade Quantitativo", '1');
    }else if(document.getElementById("pontualidade3").checked){
        localStorage.setItem("Seminário03 Pontualidade Quantitativo", '2');
    }else if(document.getElementById("pontualidade4").checked){
        localStorage.setItem("Seminário03 Pontualidade Quantitativo", '3');
    }else if(document.getElementById("pontualidade5").checked){
        localStorage.setItem("Seminário03 Pontualidade Quantitativo", '4');
    }else if(document.getElementById("pontualidade6").checked){
        localStorage.setItem("Seminário03 Pontualidade Quantitativo", '5');
    }
}
function checkedFormalidade(){
    if(document.getElementById("formalidade1").checked){
        localStorage.setItem("Seminário03 Formalidade Quantitativo", '0');
    }else if(document.getElementById("formalidade2").checked){
        localStorage.setItem("Seminário03 Formalidade Quantitativo", '1');
    }else if(document.getElementById("formalidade3").checked){
        localStorage.setItem("Seminário03 Formalidade Quantitativo", '2');
    }else if(document.getElementById("formalidade4").checked){
        localStorage.setItem("Seminário03 Formalidade Quantitativo", '3');
    }else if(document.getElementById("formalidade5").checked){
        localStorage.setItem("Seminário03 Formalidade Quantitativo", '4');
    }else if(document.getElementById("formalidade6").checked){
        localStorage.setItem("Seminário03 Formalidade Quantitativo", '5');
    }
}
function checkedInteracao(){
    if(document.getElementById("formalidade1").checked){
        localStorage.setItem("Seminário03 Interação Quantitativo", '0');
    }else if(document.getElementById("formalidade2").checked){
        localStorage.setItem("Seminário03 Interação Quantitativo", '1');
    }else if(document.getElementById("formalidade3").checked){
        localStorage.setItem("Seminário03 Interação Quantitativo", '2');
    }else if(document.getElementById("formalidade4").checked){
        localStorage.setItem("Seminário03 Interação Quantitativo", '3');
    }else if(document.getElementById("formalidade5").checked){
        localStorage.setItem("Seminário03 Interação Quantitativo", '4');
    }else if(document.getElementById("formalidade6").checked){
        localStorage.setItem("Seminário03 Interação Quantitativo", '5');
    }
}
function checkedPlanejamento(){
    if(document.getElementById("planejamento-aparente1").checked){
        localStorage.setItem("Seminário03 Planejamento Quantitativo", '0');
    }else if(document.getElementById("planejamento-aparente2").checked){
        localStorage.setItem("Seminário03 Planejamento Quantitativo", '1');
    }else if(document.getElementById("planejamento-aparente3").checked){
        localStorage.setItem("Seminário03 Planejamento Quantitativo", '2');
    }else if(document.getElementById("planejamento-aparente4").checked){
        localStorage.setItem("Seminário03 Planejamento Quantitativo", '3');
    }else if(document.getElementById("planejamento-aparente5").checked){
        localStorage.setItem("Seminário03 Planejamento Quantitativo", '4');
    }else if(document.getElementById("planejamento-aparente6").checked){
        localStorage.setItem("Seminário03 Planejamento Quantitativo", '5');
    }
}
function checkedEnsaio(){
    if(document.getElementById("ensaio1").checked){
        localStorage.setItem("Seminário03 Ensaio Quantitativo", '0');
    }else if(document.getElementById("ensaio2").checked){
        localStorage.setItem("Seminário03 Ensaio Quantitativo", '1');
    }else if(document.getElementById("ensaio3").checked){
        localStorage.setItem("Seminário03 Ensaio Quantitativo", '2');
    }else if(document.getElementById("ensaio4").checked){
        localStorage.setItem("Seminário03 Ensaio Quantitativo", '3');
    }else if(document.getElementById("ensaio5").checked){
        localStorage.setItem("Seminário03 Ensaio Quantitativo", '4');
    }else if(document.getElementById("ensaio6").checked){
        localStorage.setItem("Seminário03 Ensaio Quantitativo", '5');
    }
}
...
function processarFuncoes(){
    ...
    if(document.getElementById("ensaio1").checked || document.getElementById("ensaio2").checked || document.getElementById("ensaio3").checked || document.getElementById("ensaio4").checked || document.getElementById("ensaio5").checked || document.getElementById("ensaio6").checked) {
        if(typeof(Storage)!="undefined"){
            if(localStorage.visitaSeminario03){
                localStorage.visitaSeminario03=Number(localStorage.visitaSeminario03)+1;
            }else{
                localStorage.visitaSeminario03=1;
            }
        }
        if(localStorage.getItem("visitaSeminario03") != 1){
            return alert('❌ Formulário já foi enviado!');  
        }
        checkedIntroducao();
        checkedPostura();
        checkedFluencia();
